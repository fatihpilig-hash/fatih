...
export const process = [
  {
    ...
    title: "Analyse",
    description:
      "Wir verschaffen uns ein präzises Bild Ihres Marktes, Ihrer Zielgruppe und Ihrer bisherigen Sichtbarkeit — ohne Umwege.",
  },
  {
    index: "02",
    title: "Strategie",
    description:
      "Daraus entsteht ein klarer Fahrplan: Kanäle, Botschaften, Kampagnenlogik. Kein Standardpaket, sondern Ihr Weg.",
  },
  {
    index: "03",
    title: "Umsetzung",
    description:
      "Produktion, Kampagnen-Setup und Automatisierung laufen parallel an. Sie erhalten Ergebnisse, keine Statusmeetings.",
  },
  {
    index: "04",
    title: "Skalierung",
    description:
      "Was funktioniert, wird ausgebaut. Wir optimieren kontinuierlich anhand echter Zahlen — nicht nach Bauchgefühl.",
  },
];
...
export const contact = {
  eyebrow: "Kontakt",
  headline: "Lassen Sie uns über Ihre Sichtbarkeit sprechen.",
  body: "Ein Gespräch, 30 Minuten, kein Verkaufsdruck. Wir zeigen Ihnen, wo Ihr größtes ungenutztes Potenzial liegt.",
